...
const Navbar = ({ isDarkMode, toggleTheme }) => {
  ...
  return (
    <nav className="fixed z-10 top-0 flex items-center w-full justify-between border-b border-b-white bg-black px-16 py-6 text-white backdrop-blur-md ">
      <a href="#home" className=" text-3xl font-semibold transition-all duration-300 hover:opacity-100 ">Portfolio WebSite</a>
      <ul className="hidden md:flex gap-10 w-min-880 ">
        <a href="#home" className="text-blue-500 cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100 ">
          <li>
            Home
          </li>
        </a>
        <a href="#tech" className="text-blue-500 cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100 ">
          <li>
            Tech
          </li>
        </a>
        <a href="#project" className="text-blue-500 cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100 ">
          <li>
            Project
          </li>
        </a>
        <a href="#experience" className="text-blue-500 cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100 ">
          <li>
            Education
          </li>
        </a>
        <a href="#contact" className="text-blue-500 cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100 ">
          <li>
            Contact
          </li>
        </a>
